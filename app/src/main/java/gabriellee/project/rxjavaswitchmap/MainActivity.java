...
import gabriellee.project.rxjavaswitchmap.adapter.RecyclerAdapter;
import gabriellee.project.rxjavaswitchmap.models.Post;
import gabriellee.project.rxjavaswitchmap.request.ServiceGenerator;
        ...
        publishSubject
                ...
                .switchMap(new Function<Post, ObservableSource<Post>>() {
                    ...
                    public ObservableSource<Post> apply(final Post post) throws Exception {
                        ...
                        .takeWhile(new Predicate<Long>() { // stop the process if more than 5 seconds pass
                            @Override
